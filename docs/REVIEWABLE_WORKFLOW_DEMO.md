...
This demo exercises the published `v0.11.0` reviewable-workflow path from the
...
no local checkout is present, the script installs the published `v0.11.0` tag by
...
The published `v0.11.0` tag contains the workflow `draft-proposal` and
