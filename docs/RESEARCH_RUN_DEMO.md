...
This demo shows how a workspace user can drive the v0.12.0 external-operator
...
The script installs the framework from the published `v0.12.0` tag by default.
