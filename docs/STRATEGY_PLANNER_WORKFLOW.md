...
This demo shows the `v0.12.0` strategy-planner workflow from a user workspace.
...
The demo installs the published `v0.12.0` tag by default. For framework
